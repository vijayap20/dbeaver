...
public class ClaudePreferencePage extends AbstractPrefPage implements IWorkbenchPreferencePage {
    private static final Log log = Log.getLog(ClaudePreferencePage.class);
    ...
    private IObjectPropertyConfigurator<ClaudeCompletionEngine, AISettings> claudeConfigurator;

    public ClaudePreferencePage() {
        UIPropertyConfiguratorDescriptor cfgDescriptor = UIPropertyConfiguratorRegistry.getInstance().getDescriptor(ClaudeCompletionEngine.class.getName());
        ...
        if (configurator == null) {
            configurator = new AIClaudeConfiguratorDefault();
        }
